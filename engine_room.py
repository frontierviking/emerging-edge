...
def _source_health(db: Database) -> list[dict]:
    ...
    _NEWS_STATIC = [
        ...
        ("Ghana Business News (RSS)", False),
        ("AllAfrica Business (RSS)", False),
    ...
    _EARN_URL_KEY = {
        ...
        "africanfinancials":      "africanfinancials.com (11 African)",
        "sharedata.co.za":        "sharedata.co.za (JSE)",
        "borsaitaliana":          "borsaitaliana.it (BIT)",
        "dps.psx.com.pk":        "PSX announcements",
        "amarstock":              "amarstock.com (DSEB)",
        "kase.kz":                "KASE events calendar",
        "nse.co.ke":              "NSE Kenya calendar",
        "hkexnews":               "HKEXnews (HKSE)",
        "bseindia":               "BSE India forthcoming results",
        "eho.zse.hr":             "ZSE issuer announcements",
        "bsse.sk":                "BSSE announcements",
        "pngx.com.pg":            "PNGX announcements",
        "fundamentus":            "fundamentus.com.br (B3)",
        "belex.rs":               "BELEX calendar",
    ...
    _EARN_STATIC = [
        ...
        ("africanfinancials.com (11 African)", False),
        ("sharedata.co.za (JSE)",          False),
        ("borsaitaliana.it (BIT)",         False),
        ("PSX announcements",              False),
        ("amarstock.com (DSEB)",           False),
        ("KASE events calendar",           False),
        ("NSE Kenya calendar",             False),
        ("HKEXnews (HKSE)",               False),
        ("BSE India forthcoming results",  False),
        ("ZSE issuer announcements",       False),
        ("BSSE announcements",             False),
        ("PNGX announcements",             False),
        ("fundamentus.com.br (B3)",        False),
        ("BELEX calendar",                 False),
